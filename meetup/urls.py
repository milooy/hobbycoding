...
urlpatterns = [
    ...
    url(r'^meetup/(?P<pk>[0-9]+)/edit/$', login_required(views.MeetupFormView.as_view()), name='meetup_edit'),
    url(r'^meetup/new/$', login_required(views.MeetupFormView.as_view()), name='meetup_new'),
